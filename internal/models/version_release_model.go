...
type VersionRelease struct {
	...
	ProjectID   uint   `gorm:"foreignkey:ProjectID;column:project_id" json:"project_id" form:"project_id"`
	CommitID    string `gorm:"unique;column:commit_id" json:"commit_id" form:"commit_id"`
